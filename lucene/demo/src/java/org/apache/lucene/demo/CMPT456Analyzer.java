...
public final class CMPT456Analyzer extends StopwordAnalyzerBase {
    ...
    public CMPT456Analyzer() throws IOException {
        super(loadStopwordSet(new BufferedReader(new InputStreamReader(Files.newInputStream(Paths.get("./lucene/demo/src/java/org/apache/lucene/demo/stopwords.txt")), StandardCharsets.UTF_8))));
    }
